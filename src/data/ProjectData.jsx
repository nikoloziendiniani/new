...
const ApartmentsData = [
  {
    ...
    background: image1,
    price: { perMonth: 1800, perYear: 21600 },
    city: "tbilisi",
    street: "რუთაველის გამზირი",
    rooms: 2,
    area: 75,
    sold: false,
  ...
  },
  {
    ...
    background: image2,
    price: { perMonth: 2500, perYear: 30000 },
    city: "tbilisi",
    street: "ჩიქოვანის ქუჩა",
    rooms: 3,
    area: 90,
    sold: false,
    coments: [{ opinion: "ძალიან კარგი ადგილმდებარეობა და მყუდრო გარემო.", rating: 5 }],
    num: 56694759,
  },
  {
    id: 3,
    ...
    background: image3,
    price: { perMonth: 2700, perYear: 32400 },
    city: "batumi",
    street: "რუსთაველის ქუჩა",
    rooms: 2,
    area: 80,
    sold: true,
    coments: [{ opinion: "საუკეთესო ხედები ზღვაზე!", rating: 5 }],
    num: 56684396,
  },
  {
    id: 4,
    ...
    background: image4,
    price: { perMonth: 1600, perYear: 19200 },
    city: "tbilisi",
    street: "ქეთევან წამებულის გამზირი",
    rooms: 2,
    area: 70,
    sold: false,
    coments: [{ opinion: "მშვენიერი ინფრასტრუქტურა და კულტურული გარემო.", rating: 4 }],
    num: 577937493,
  },
  {
    id: 5,
    ...
    background: image5,
    price: { perMonth: 2200, perYear: 26400 },
    city: "tbilisi",
    street: "ქავთარაძის ქუჩა",
    rooms: 3,
    area: 85,
    sold: true,
    coments: [{ opinion: "საკმაოდ დიდი სივრცე და კარგი ნათება.", rating: 4 }],
    num: 577493829,
  },
  {
    id: 6,
    ...
    background: image6,
    price: { perMonth: 1200, perYear: 14400 },
    city: "tbilisi",
    street: "ხიზანიშვილის ქუჩა",
    rooms: 2,
    area: 65,
    sold: false,
    coments: [{ opinion: "მისაღები ფასი და კარგია ახალგაზრდებისთვის.", rating: 3 }],
    num: 56773920,
  },
  {
    id: 7,
    ...
    background: image7,
    price: { perMonth: 2600, perYear: 31200 },
    city: "tbilisi",
    street: "ჭავჭავაძის გამზირი",
    rooms: 3,
    area: 95,
    sold: false,
    coments: [{ opinion: "ძვირი, მაგრამ ნამდვილად ღირს.", rating: 5 }],
    num: 577390472,
  },
  {
    id: 8,
    ...
    background: image8,
    price: { perMonth: 1700, perYear: 20400 },
    city: "tbilisi",
    street: "მირიან მეფის ქუჩა",
    rooms: 3,
    area: 80,
    sold: false,
    coments: [{ opinion: "კარგი გარემო და ინფრასტრუქტურა.", rating: 4 }],
    num: 57793924,
  },
  {
    id: 9,
    ...
    background: image9,
    price: { perMonth: 1500, perYear: 18000 },
    city: "tbilisi",
    street: "ლილო, ძველი გზა",
    rooms: 2,
    area: 70,
    sold: true,
    coments: [{ opinion: "ღირებულების შესაბამისად კარგი ვარიანტია.", rating: 4 }],
    num: 577393843,
  },
];
